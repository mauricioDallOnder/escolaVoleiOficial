  ...
  <Box sx={{ width: drawerWidth, flexShrink: 0, bgcolor: '#f4f4f4' }}>
    ...
    <List sx={{ padding: 0 }}>
      {[
        ...
        { icon: <GroupAddIcon color="secondary" />, text: "Cadastrar alunos novos", href: "/StudentRegistration" },
        { icon: <SettingsIcon color="error" />, text: "Trocar aluno de turma", href: "/StudentUpdateTurmas" },
        { icon: <ListAltIcon color="action" />, text: "Listas de Chamadas dos Profs", href: "/StudentPresenceTable" },
        { icon: <UpdateIcon color="disabled" />, text: "Atualização Cadastral dos alunos", href: "/StudentUpdatePersonalInformation" },
        ...
        { icon: <AutoDeleteIcon color="error" />, text: "Deletar alunos", href: "/ArquivarAlunos" },
        { icon: <ChangeCircleIcon color="warning" />, text: "Trocar Semestre", href: "/MudarSemestre" },
        { icon: <FileDownloadIcon color="success" />, text: "Criação e atualização de turmas", href: "/HandleTurmas" },
      ].map((item, index) => (
